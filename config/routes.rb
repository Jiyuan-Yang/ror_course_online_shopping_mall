Rails.application.routes.draw do
  ...
  get '/products/:id/add_to_favorite', to: 'static_pages#invalid_get_handler'
  post '/products/:id/add_to_favorite',
       to: 'favorites#add_to_favorite', as: 'add_to_favorite'

  # deal with invalid get access
  get '/products/:id/add_one_item_to_order', to: 'static_pages#invalid_get_handler'
  post '/products/:id/add_one_item_to_order',
       to: 'orders#add_one_item_to_order', as: 'add_one_item_to_order'

  # deal with invalid get access
  get '/users/:id/add_items_in_shopping_cart_to_order', to: 'static_pages#invalid_get_handler'
  ...
  # deal with invalid get access
  get '/users/:id/shopping_cart/cart_item_destroy/:cart_item_id', to: 'static_pages#invalid_get_handler'
  delete '/users/:id/shopping_cart/cart_item_destroy/:cart_item_id',
         to: 'shopping_cart_items#destroy', as: 'cart_item_destroy'

  # deal with invalid get access
  get '/users/:id/favorite/favorite_item_destroy/:favorite_item_id', to: 'static_pages#invalid_get_handler'
  delete '/users/:id/favorite/favorite_item_destroy/:favorite_item_id',
         to: 'favorite_items#destroy', as: 'favorite_item_destroy'

  # deal with invalid get access
  get '/users/:id/order/order_destroy/:order_id', to: 'static_pages#invalid_get_handler'
  ...
  # deal with invalid get access
  get '/orders/:order_id/:order_item_id', to: 'static_pages#invalid_get_handler'
